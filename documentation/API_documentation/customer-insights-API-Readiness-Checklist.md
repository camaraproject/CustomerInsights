...
Checklist for Customer Insights v0.3.0-rc.1 in r3.1
...
| 13 | API description (for marketing)              |   O   |         O         |    M    |    M   |  Y   | [wiki link](https://lf-camaraproject.atlassian.net/wiki/x/RYHWB) |
