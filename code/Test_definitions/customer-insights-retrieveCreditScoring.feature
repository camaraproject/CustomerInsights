Feature: CAMARA Customer Insights API, v0.1 - Operation retrieveCreditScoring
  ...
  @retrieve_credit_scoring_01_generic_success_scenario
  Scenario: Common validations for any success scenario
    ...
    And the response body complies with the OAS schema at "/components/schemas/CreditScoringResponse"

  @retrieve_credit_scoring_02_generic_success_scenario_with_id_document_information
  ...
  @retrieve_credit_scoring_03_generic_success_scenario_with_scoring_type_information
  ...
  @retrieve_credit_scoring_04_generic_phone_number_identification_via_access_token
  ...
  @retrieve_credit_scoring_05_generic_phone_number_identification_via_request_body
  ...
  @retrieve_credit_scoring_400.01_no_request_body
  ...
  @retrieve_credit_scoring_C02.01_phone_number_not_schema_compliant
  ...
  @retrieve_credit_scoring_401.01_no_authorization_header
  ...
  @retrieve_credit_scoring_401.02_expired_access_token
  ...
  @retrieve_credit_scoring_401.03_invalid_access_token
  ...
  @retrieve_credit_scoring_403.01_invalid_token_permissions
  Scenario: Inconsistent access token permissions
    # To test this, an access token has to be obtained without customer-insights:credit-scoring:read scope
    Given the request body is set to a valid request body
    And the header "Authorization" is set to a valid access token emitted without customer-insights:credit-scoring:read scope
    When the HTTP "POST" request is sent
  ...
  @retrieve_credit_scoring_404.01_not_found
  Scenario: Scoring not found
    # To test this, a 2-legged access token is needed, just because if not it triggers test "@retrieve_credit_scoring_C02.03_unnecessary_phone_number"
  ...
  @retrieve_credit_scoring_422.01_scoring_type_not_supported
  ...
  @retrieve_credit_scoring_422.02_identifiers_mismatch
  ...
  @retrieve_credit_scoring_422.03_id_document_not_supported
  ...
  @retrieve_credit_scoring_422.04_id_document_required
  # Scenario that may apply depending on Telco Operator business rules
