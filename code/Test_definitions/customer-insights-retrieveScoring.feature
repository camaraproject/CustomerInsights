Feature: CAMARA Customer Insights API, v0.3.0-rc.1 - Operation retrieveScoring
  ...
  Background: Common retrieveScoring setup
    Given the resource "/customer-insights/v0.3rc1/scoring/retrieve"
  ...
  @retrieve_scoring_400.02_invalid_x-correlator
  ...
  @retrieve_scoring_C02.02_phone_number_not_found
